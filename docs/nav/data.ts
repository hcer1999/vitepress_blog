...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      ...
      {
        icon: 'https://www.loadership.com/loadership_logo_text.svg',
        title: 'Loadership',
        desc: '生成常用css加载动画',
      ...
      },
      {
        ...
        title: 'ScrollReveal',
        desc: '一个用于在页面滚动时显示和隐藏元素的 JavaScript 库',
        link: 'https://www.scrollrevealjs.org',
      },
      {
        title: 'Isotope',
        desc: '一个用于在页面过滤元素或者对元素进行排序的库',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://faceswap.so/images/logo.png',
        title: 'faceswap',
        desc: 'AI 换脸',
        link: 'https://faceswap.so',
      },
    ],
  },
  {
