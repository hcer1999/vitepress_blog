...
之前支持同步访问的动态渲染 API 现在是异步的。你可以在[升级指南](/docs/app/guides/upgrading/version-15)中阅读有关此破坏性变更的更多信息。
...
将匿名组件转换为命名组件，以确保它们与 [Fast Refresh](https://nextjs.org/blog/next-9-4#fast-refresh) 一起工作。
